...
<template>
  <section data-testid="home-clock-show" class="mt-8">
    <svg class="h-full w-full" viewBox="-50 -50 100 100">
      ...
      <template v-for="minute in [0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55]" :key="minute">
        <line
          class="stroke-surface-700 stroke-1"
          y1="35"
          y2="45"
        ...
        <line
          ...
          :key="offset"
          class="stroke-surface-500 stroke-1"
          y1="42"
          y2="45"
      ...
      <g :transform="`rotate(${6 * props.seconds})`">
        <line class="stroke-color-primary" y1="10" y2="-38" />
        <line class="stroke-color-primary stroke-2" y1="10" y2="2" />
      </g>
    </svg>
  </section>
</template>
